...
function VivosMAEPP_MetaData() {
    return array(
        'DisplayName' => 'VivosMAEPP',
        'APIVersion' => '1.1',
    );
}
require '/home/cloudert/dashboard/vendor/phpmailer/phpmailer/PHPMailerAutoload.php';
function VivosMAEPP_getConfigArray() {
    $configarray = array(
...
function VivosMAEPP_AdminCustomButtonArray() {
    $buttonarray = array(
...
function VivosMAEPP_ClientAreaCustomButtonArray() {
    //$buttonarray = array(
...
function VivosMAEPP_GetNameservers($params) {
    # Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($result);
        logModuleCall('VivosMAEPP', 'GetNameservers', $xml, $result);
...
function VivosMAEPP_SaveNameservers($params) {
    # Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";
...
');
                ...
                $doc = new DOMDocument();
                $doc->loadXML($request);
                logModuleCall('VivosMAEPP', 'SaveNameservers', $xml, $request);
...
function VivosMAEPP_GetRegistrarLock($params) {
    ...
    try {
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'GetRegistrarLock', $xml, $request);
        $coderes = $doc->getElementsByTagName('result')->item(0)->getAttribute('code');
        $msg = $doc->getElementsByTagName('msg')->item(0)->nodeValue;
        # Check result
        if (!eppSuccess($coderes)) {
...
function VivosMAEPP_SaveRegistrarLock($params) {
    # Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";

    if (VivosMAEPP_GetRegistrarLock($params) == "unlocked" && $params["lockenabled"] == "locked") {
        VivosMAEPP_LockDomain($params);
    } else {
        if (VivosMAEPP_GetRegistrarLock($params) == "locked" && $params["lockenabled"] == "unlocked") {
            VivosMAEPP_UnlockDomain($params);
        } else {
...
function VivosMAEPP_LockDomain($params) {
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";
...
# Parse XML result
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'Lock-Delete-Transfer', $xml, $request);
        $coderes = $doc->getElementsByTagName('result')->item(0)->getAttribute('code');
        $msg = $doc->getElementsByTagName('msg')->item(0)->nodeValue;
        # Check result
        if (!eppSuccess($coderes)) {
...
function VivosMAEPP_UnlockDomain($params) {
    # Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";
    try {
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'Remove UpdateProhibited', $xml, $request);
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'Domain UnLock', $xml, $request);
...
function VivosMAEPP_RegisterDomain($params) {
    # Grab varaibles
    $sld = $params["sld"];
    $tld = $params["tld"];
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'RegisterDomain', $xml, $request);
...
function VivosMAEPP_TransferDomain($params) {
    # Grab variables
   ...
   <epp xmlns="urn:ietf:params:xml:ns:epp-1.0">
     <command>
       <transfer op="request">
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'TransferDomain', $xml, $request);
...
function VivosMAEPP_RenewDomain($params) {
# Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $regperiod = $params["regperiod"];
    ...
    try {
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'RenewDomain', $xml, $request);
        ...
        if ($statusres == "pendingDelete") {
            ...
            $doc = new DOMDocument();
            $doc->loadXML($request);
            logModuleCall('VivosMAEPP', 'RestoreDomain', $xml, $request);
            $coderes = $doc->getElementsByTagName('result')->item(0)->getAttribute('code');
            $msg = $doc->getElementsByTagName('msg')->item(0)->nodeValue;
            if (!eppSuccess($coderes)) {
...
function VivosMAEPP_GetContactDetails($params) {
    # Grab variables
    $sld = $params["sld"];
    $tld = $params["tld"];
    $domain = "$sld.$tld";
...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <command>
    ...
    <clTRID>' . mt_rand() . mt_rand() . '</clTRID>
        ...
        $doc = new DOMDocument();
        $doc->loadXML($result);
        logModuleCall('VivosMAEPP', 'Get Contact Details', $xml, $result);
...
function getContactDetail($client, $contactID) {
   ...
   <epp xmlns="urn:ietf:params:xml:ns:epp-1.0">
    ...
    $doc = new DOMDocument();
    $doc->loadXML($request);
    logModuleCall('VivosMAEPP', 'GetContactDetails', $xml, $request);
...
function VivosMAEPP_SaveContactDetails($params) {
    # Grab variables
    $tld = $params["tld"];
    $sld = $params["sld"];
    ...
    <command>
      <update>
       ...
       <clTRID>' . mt_rand() . mt_rand() . '</clTRID>
            ...
            $doc = new DOMDocument();
            $doc->loadXML($request);
            logModuleCall('VivosMAEPP', 'SaveContactDetails', $xml, $request);
...
function createContact($client, $data, $type = "") {
  ...
  <epp xmlns="urn:ietf:params:xml:ns:epp-1.0">
    ...
    $doc = new DOMDocument();
    $doc->loadXML($result);
    logModuleCall('VivosMAEPP', 'SaveContactDetails', $xml, $result);
...
function VivosMAEPP_GetEPPCode($params) {
    # Grab variables
    global $CONFIG;
...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <command>
    ...
    <clTRID>' . mt_rand() . mt_rand() . '</clTRID>
        ...
        $doc = new DOMDocument();
        $doc->loadXML($result);
        logModuleCall('VivosMAEPP', 'Get EPP Code', $xml, $result);
        ...
        # Check result
        if (!eppSuccess($coderes)) {
            $values["error"] = "GetEPPCode/domain-info($sld.$tld): Code (" . $coderes . ") " . $msg;
            return $values;
        }
        ...
        $contactID = $domaininfo["admin"];
        $contact = getContactDetail($client, $contactID);
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'EPPCODE', $xml, $request);
        $message = '<p>Votre code EPP est: <b>' . $newEppKey . '</b></p>';
        smtpSendEmail($adminemail, $CONFIG['Email'], $CONFIG['CompanyName'], "Denamde de code EPP", $message);
        $values["eppcode"] = "sent to domain admin contact email";
        # If error, return the error message in the value below
        $coderes = $doc->getElementsByTagName('result')->item(0)->getAttribute('code');
        $msg = $doc->getElementsByTagName('msg')->item(0)->nodeValue;
        if (!eppSuccess($coderes)) {
...
function VivosMAEPP_RegisterNameserver($params) {
    # Grab variables
    $username = $params["Username"];
    $password = $params["Password"];
    $testmode = $params["TestMode"];
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'RegisterNameserver', $xml, $request);

        # Pull off status
        $coderes = $doc->getElementsByTagName('result')->item(0)->getAttribute('code');
        $msg = $doc->getElementsByTagName('msg')->item(0)->nodeValue;
        logModuleCall('VivosMAEPP', 'SaveHost', $xml, $request);
        # Check if result is ok
        if (!eppSuccess($coderes)) {
...
function VivosMAEPP_ModifyNameserver($params) {
    # Grab variables
    $username = $params["Username"];
    $password = $params["Password"];
    $testmode = $params["TestMode"];
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'ModifyNameserver', $xml, $request);
...
function VivosMAEPP_DeleteNameserver($params) {
    # Grab variables
    $username = $params["Username"];
    $password = $params["Password"];
    $testmode = $params["TestMode"];
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'DeleteNameserver', $xml, $request);
...
function _VivosMAEPP_message($code) {
    return "Code $code";
}

# Function to create internal EPP request

function _VivosMAEPP_Client() {
    # Setup include dir
...
');
    logModuleCall('VivosMAEPP', 'Connect', $xml, $request);
    return $client;
}

function VivosMAEPP_TransferSync($params) {
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'TransferSync', $xml, $request);
        ...
        if ($coderes == '2303') {
            ...
            $values['error'] = "TransferSync/domain-info($domain): Code(" . _VivosMAEPP_message($coderes) . ") $msg";
            return $values;
        }
...
// we can use VivosMAEPP_Sync script instaed of using this function
function VivosMAEPP_Sync($params) {
    
}

function VivosMAEPP_RequestDelete($params) {
    $sld = $params['sld'];
    $tld = $params['tld'];
    $domain = "$sld.$tld";
    try {
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'RequestDelete', $xml, $request);
        ...
        # Check result
        if (!eppSuccess($coderes)) {
            $values['error'] = 'RequestDelete/domain-info(' . $sld . '.' . $tld . '): Code(' . _VivosMAEPP_message($coderes) . ") $msg";
            return $values;
        }
...
function VivosMAEPP_ApproveTransfer($params) {
    $sld = $params['sld'];
    $tld = $params['tld'];
    $domain = "$sld.$tld";
    # 
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'ApproveTransfer', $xml, $request);
        ...
        # Check result
        if (!eppSuccess($coderes)) {
            $values['error'] = 'ApproveTransfer/domain-info(' . $sld . '.' . $tld . '): Code(' . _VivosMAEPP_message($coderes) . ") $msg";
            return $values;
        }
...
function VivosMAEPP_CancelTransferRequest($params) {
    $sld = $params['sld'];
    $tld = $params['tld'];
    $domain = "$sld.$tld";
    try {
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'CancelTransferRequest', $xml, $request);
        ...
        # Check result
        if (!eppSuccess($coderes)) {
            $values['error'] = 'CancelTransferRequest/domain-info(' . $sld . '.' . $tld . '): Code(' . _VivosMAEPP_message($coderes) . ") $msg";
            return $values;
        }
...
function VivosMAEPP_RejectTransfer($params) {
    $sld = $params['sld'];
    $tld = $params['tld'];
    $domain = "$sld.$tld";
    try {
...
');
        ...
        $doc = new DOMDocument();
        $doc->loadXML($request);
        logModuleCall('VivosMAEPP', 'RejectTransfer', $xml, $request);
        ...
        # Check result
        if (!eppSuccess($coderes)) {
            $values['error'] = 'RejectTransfer/domain-info(' . $sld . '.' . $tld . '): Code(' . _VivosMAEPP_message($coderes) . ") $msg";
            return $values;
        }
...
function smtpSendEmail($toemail, $fromemail, $fromname, $subject, $message) {
