...
$additionaldomainfields[".ma"][] = array(
    "Name" => "ID Titulaire ou Passeport",
    "LangVar" => "NID",
    "Type" => "text",
    "Size" => "20",
    "Default" => "ID Titulaire",
    "Required" => true,
    );
...
if (file_exists($filename)) {
    ...
    die('Can not load InterNetX_additionaldomainfields.php File error: resources/domains/dist.additionaldomainfields.php');
}
